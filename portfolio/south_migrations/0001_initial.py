...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PortfolioPage'
        db.create_table(u'portfolio_portfoliopage', (
        ...
        db.send_create_signal(u'portfolio', ['PortfolioPage'])


    def backwards(self, orm):
        # Deleting model 'PortfolioPage'
        db.delete_table(u'portfolio_portfoliopage')
